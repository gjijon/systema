...
a persistence unit "systemaPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/fin/bce/jj/systema/systema/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "systema/pom.xml":
...
artifacts ("systema-ejb.jar" and "systema-web.war") are already built. You can build
